...
.sidebar a:hover {
    background-color: #45a049;  /* Adjusted green shade */
    transform: translateX(10px);
}

.sidebar a:active {
    background-color: #388e3c;  /* Slightly darker green when clicked */
...
.main-content {
    margin-left: 250px;
    padding: 20px;
    background-color: #e8f5e9;  /* Lighter green for main content */
    overflow-y: auto;
    border-radius: 10px;
...
h2 {
    color: #388e3c;  /* Matching green for header */
    font-size: 24px;
    margin-bottom: 20px;
}
...
table th {
    background-color: #388e3c;  /* Updated green shade */
    color: white;
    text-align: center;
}
...
button {
    background-color: #388e3c;  /* Matching green for buttons */
    color: white;
    padding: 12px 24px;
    font-size: 16px;
    border-radius: 5px;
...
button:hover {
    background-color: #45a049;  /* Lightened green when hovered */
    transform: scale(1.05);
}

button:active {
    background-color: #2e7d32;  /* Slightly darker green when clicked */
    transform: scale(1);
}
    ...
    <div class="dashboard-container">
        ...
        <div class="main-content">
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>Tenant ID</th>
                        <th>Status</th>
                        <th>Business Type</th> <!-- Added Business Type -->
                        <th>Created At</th>
                        <th>Updated At</th>
                        <th>Actions</th>
                    </tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($space['business_type']); ?></td> <!-- Display Business Type -->
            ...
            <form method="post" class="form-container">
                ...
                <input type="text" name="business_type" placeholder="Business Type" required> <!-- Add Business Type Input -->
